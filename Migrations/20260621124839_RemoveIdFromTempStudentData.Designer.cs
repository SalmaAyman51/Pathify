...
namespace Pathify.Migrations
{
    ...
    [Migration("20260621124839_RemoveIdFromTempStudentData")]
    partial class RemoveIdFromTempStudentData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pathify.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("TempStudentDataSSN")
            ...
            modelBuilder.Entity("Pathify.Models.ApplicationUser", b =>
                {
                    b.HasOne("Pathify.Models.TempStudentData", "TempStudentData")
                        .WithMany()
                        .HasForeignKey("TempStudentDataSSN");
            ...
            modelBuilder.Entity("Pathify.Models.TeamMember", b =>
                {
                    b.HasOne("Pathify.Models.Student", "Student")
                        .WithMany()
                        .HasForeignKey("StudentSsn")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
